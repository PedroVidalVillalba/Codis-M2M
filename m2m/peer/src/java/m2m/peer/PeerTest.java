...
public class PeerTest {
    public static void main(String[] args) throws Exception {
        ...
        User malice = new User("alice", "666");
        try {
            bob.getReference().message(alice.getReference(), "Hola Bob!");
        } catch (Exception e) {
            System.out.println("Malice no pudo falsificar el mensaje: " + e.getMessage());
        }
        try {
            malice.removeFriendship("bob");
            System.out.println("Malice consiguió eliminar la amistad de Alice y Bob!");
        } catch (Exception e) {
            System.out.println("Malice no pudo romper la amistad de Alice y Bob: " + e.getMessage());
        }
